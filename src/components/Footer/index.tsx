...
import { selectorsFooter } from "@/ducks/footer";
import Link from "next/link";
import { v4 as uuidv4 } from "uuid";
import { Footer as FooterType } from "@/ducks/footer/types";
...
export function FooterComponent({ footerData }: FooterComponentProps) {
  return (
...
const wrapperCourses = (Component: any) => {
  return function WrapperCourses() {
    ...
    const selectorsData = selectorsFooter.selectFooterData(store);
